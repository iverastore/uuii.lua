...
local Library; do
	...
	do -- Library
		...
		function Library:UserInfo(Data)
			Data = Data or {};
			if not Library.MainFrame or not Library.MainFrame.Object then return end;

			local TabsFrame = Library.MainFrame.Object:FindFirstChild("Inline") and Library.MainFrame.Object.Inline:FindFirstChild("Tabs")
			local ParentFrame = TabsFrame or Library.MainFrame.Object

			local InfoFrame = Objects:New("Frame", {
				Parent = ParentFrame;
				Name = "UserInfo";
				BackgroundColor3 = Library.Theme.Element;
				BorderSizePixel = 0;
				Size = U2New(1, -12, 0, 44);
				Position = U2New(0, 6, 1, -50);
				ZIndex = 6;
			}); Library:AddToTheme(InfoFrame.Object, {BackgroundColor3 = "Element"});

			InfoFrame:Border();

			local AvatarImg = Objects:New("ImageLabel", {
				Parent = InfoFrame.Object;
				Name = "Avatar";
				BackgroundColor3 = Library.Theme.Element;
				BorderSizePixel = 0;
				Size = U2New(0, 34, 0, 34);
				Position = U2New(0, 5, 0.5, -17);
				Image = Data.AvatarImage or "";
				ZIndex = 7;
			}); Library:AddToTheme(AvatarImg.Object, {BackgroundColor3 = "Element"});

			Objects:New("UICorner", {
				Parent = AvatarImg.Object;
				CornerRadius = UDim.new(0, 4);
			});

			local IdLabel = Objects:New("TextLabel", {
				Parent = InfoFrame.Object;
				Name = "UserID";
				FontFace = UIFont;
				TextColor3 = Library.Theme.Text;
				BorderColor3 = FromRGB(0, 0, 0);
				Text = Data.UserId and ("userid: " .. tostring(Data.UserId)) or "userid: ?";
				BackgroundTransparency = 1;
				TextXAlignment = Enum.TextXAlignment.Left;
				Position = U2New(0, 42, 0, 6);
				Size = U2New(1, -46, 0, 14);
				BorderSizePixel = 0;
				TextSize = 12;
				TextTruncate = Enum.TextTruncate.AtEnd;
				ZIndex = 7;
			}); Library:AddToTheme(IdLabel.Object, {TextColor3 = "Text"});

			local KeyLabel = Objects:New("TextLabel", {
				Parent = InfoFrame.Object;
				Name = "KeyTime";
				FontFace = UIFont;
				TextColor3 = Library.Theme.Text;
				BorderColor3 = FromRGB(0, 0, 0);
				Text = Data.KeyTime and ("key time: " .. tostring(Data.KeyTime)) or "key time: Lifetime";
				BackgroundTransparency = 1;
				TextXAlignment = Enum.TextXAlignment.Left;
				Position = U2New(0, 42, 0, 22);
				Size = U2New(1, -46, 0, 14);
				BorderSizePixel = 0;
				TextSize = 12;
				TextTruncate = Enum.TextTruncate.AtEnd;
				ZIndex = 7;
			}); Library:AddToTheme(KeyLabel.Object, {TextColor3 = "Text"});

			IdLabel:TextBorder();
			KeyLabel:TextBorder();

			local UserInfo = {
				Object = InfoFrame.Object;
			};

			function UserInfo:SetVisible(Bool)
				InfoFrame.Object.Visible = Bool;
			end;
